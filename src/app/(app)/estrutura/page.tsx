...
export default async function StructurePage({ searchParams }: PageProps<"/estrutura">) {
  ...
  return (
    <div className="animate-in">
      <PageHeader eyebrow={user.condominium?.name} title="Estrutura do condomínio" description="Torres ou quadras, unidades, áreas comuns e categorias de serviço usadas nas ordens de serviço." />
